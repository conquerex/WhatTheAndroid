...
public class Mission3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=findViewById(R.id.mission3_recyclerView);
    ...
    class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            if(i == ItemVO.TYPE_HEADER){
                View view= LayoutInflater.from(Mission3Activity.this).inflate(R.layout.mission3_item_header, viewGroup, false);
                return new HeaderViewHolder(view);
            }else{
                View view= LayoutInflater.from(Mission3Activity.this).inflate(R.layout.mission3_item_data, viewGroup, false);
